...
// Only admin routes
router.get('/:userId', authenticate, adminCheck, getUserBorrowHistory); // Route to get users borrowed history. GET http://localhost:8000/api/v1/borrow/:userId?page=2&size=10
